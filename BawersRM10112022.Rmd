...
author: "Bawer Betasi, Anuar Baisynov, Martin Bech, Thomas Madsen, Marius McIntosh"
output: 
  html_document:
    highlight: tango
    theme: darkly
...
# Note to TA: we changed this into a comment rather than deleting it to show how we had to improve an error: 
...
improvedtele_model2 <- neuralnet(y ~., data = tele_train2, hidden = 2, stepmax = 1e+08)
